...
const (
	...
	hintFmtParameterType  = "Every parameter says what it takes, for example 'takes %s as number'."
	hintFmtFunctionResult = "Add 'and gives back a number', or 'and gives back nothing' when %s produces no value."
	hintNothingResultOnly = "Only a function's result can be nothing. A variable must have a type it can hold."
...
const (
	...
	msgFmtParameterNeedsType  = "The parameter '%s' needs a type."
	msgFmtFunctionNeedsResult = "The function '%s' must say what it gives back."
	msgNothingNotAValueType   = "'nothing' is not a type a value can have."
